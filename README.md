...
<p>Что нужно было сделать:</p>
 Задача 1:
 Свести баланс студентов в SQL
 Задача 2:
 Проанализирвоать полученные данные, при необходимости - задать вопросы дата-инженерам относительно данных, содержащихся в таблице
 Задача 3:
